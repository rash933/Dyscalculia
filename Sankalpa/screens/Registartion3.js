            ...
            <View style={styles.InputBox}>
                ...
                <View style={styles.input} >
                    <View style={styles.textFeild}>
                        <Text style={{ textAlign: 'left' }} variant="labelLarge">Email Address</Text>
                        ...
                        />
                        <Text style={{ textAlign: 'left', color: '#ec0b43' }} variant="labelLarge">Invalid Email</Text>
                    </View>
                    <View style={styles.textFeild}>
                        ...
                        />
                        <Text style={{ textAlign: 'left', color: '#ec0b43' }} variant="labelLarge">Invalid Password</Text>
                    </View>
                    <View style={styles.textFeild}>
                        <Text style={{ textAlign: 'left' }} variant="labelLarge">Confirme Password</Text>
                        <TextInput style={{ width: 250 }}
                            mode="outlined"
                            outlineColor='#000'
                            label=""
                        ...
                        />
                        <Text style={{ textAlign: 'left', color: '#ec0b43' }} variant="labelLarge">Password doesn't match</Text>
                    </View>
