...
const GamePage3 = ({ navigation, route }) => {
    const { G4 } = route.params;
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            if (!buttonPressed) {
                ...
                const G5 = { ...G4, g5: 'false' };
                console.log(G5);

                // Navigate to another screen
                navigation.navigate('GamePage16', { G5 });
            }
                            ...
                            <View style={styles.boxb}>
                                <View style={styles.Bgroup} >
                                    <Image
                                        resizeMode='contain'
                                        style={styles.Image}
                                        source={require('../assets/image/set/2.png')}
                                    />
                                    <Text style={styles.largeText} variant="displayLarge">  =    9</Text>
                                </View>
