            ...
            <View style={styles.box1}>
                ...
                <View style={styles.box3}>
                    ...
                    <View style={styles.input} >
                        <Text style={{ textAlign: 'left' }} variant="titleMedium">Name of Teacher</Text>
                        ...
                        />
                        <Text style={{ textAlign: 'left', color: '#ec0b43' }} variant="titleMedium">Add both first and last names</Text>
                    </View>
                ...
                <View style={styles.box4}>
                    <Button textColor='#ffff' onPress={() => { navigation.navigate('CheckIQ3') }} mode='contained'>CONTINUE</Button>
                </View>
            </View>
